const COSMETIC_RATINGS = [
  { stars: 5, label: "5 — Excellent", desc: "Like-new condition. No damage." },
  { stars: 4, label: "4 — Very Good", desc: "Light scratches, never dropped." },
  { stars: 3, label: "3 — Good", desc: "Minor cosmetic damage from light drop." },
  { stars: 2, label: "2 — Fair", desc: "Moderate damage; may need bodywork." },
  { stars: 1, label: "1 — Poor", desc: "Unrepaired crash damage; bent parts." },
];
